...
else if (instance_exists(obj_player) && obj_player.state != 50 && room != rank_room && room != timesuproom)
    jingle = 0;
if (global.panic == 1 && currentlyplaying != music_tutorial && (!audio_is_playing(music_noiseappear)))
