if (state != 92) {
    with (obj_player) {
        ...
        if (state == 55) {
            ...
            other.stunned = 40;
            if (x != other.x) other.image_xscale = (-sign((other.x - x)));
            other.vsp = -5;
            other.hsp = ((-other.image_xscale) * 3);
            hsp = ((-xscale) * 4);
            vsp = -4;
        ...
        if ((attacking == 0) && (((state != 43) && (state != 59)) && ((!(y < other.y)) && ((grabbing == 0) && (other.state != 89))))) {
            ...
            other.vsp = -4;
            if ((other.state == 85) || (other.state == 81)) other.state = 79;
            if (other.sprite_index == other.recoveryspr) stunned = 200;
            image_index = 0;
            state = 58;
            if (other.state == 87) other.state = 79;
        }
    }
}